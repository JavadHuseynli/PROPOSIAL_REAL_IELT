  ...
  useEffect(() => {
    async function assignRandomTest() {
      try {
        ...
        if (tests.length === 0) {
          setError("Aktiv writing testi yoxdur");
          setLoading(false);
          return;
        }
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">Sizə təyin olunmuş writing testi</p>
      </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between rounded-md bg-green-100 px-4 py-3">
                ...
                {completedAttempt.score !== null ? (
                  ...
                  <span className="text-sm text-amber-700">Qiymətləndirmə gözlənilir</span>
                )}
              </div>
              <button
