  ...
  useEffect(() => {
    async function assignTest() {
      try {
        ...
        if (tests.length === 0) { setError("Aktiv reading testi yoxdur"); return; }
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="rounded-lg border border-border bg-card p-8">
        ...
        {assignedTest.description && <p className="mt-2 line-clamp-3 text-sm text-muted-foreground">{assignedTest.description}</p>}
